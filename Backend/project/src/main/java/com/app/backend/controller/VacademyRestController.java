...
import com.app.backend.database.*;
import com.app.backend.model.*;
import com.app.backend.service.Mailer;
...
public class VacademyRestController
{
    ...
    public String createUser(@RequestBody User new_user)
    {
    	 try {
         	...
         	String text ="heyyy you made the right choice in life";
             ...
             if (userRepository.existsUserByUsername(new_user_name)) {
                 ...
                 userRepository.save(new_user);
                  email.sendMail(new_user_email,subject,text);

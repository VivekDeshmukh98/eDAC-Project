...
import com.app.backend.database.AdminRepository;
import com.app.backend.database.InstructorRepository;
import com.app.backend.database.UserRepository;
...
public class JwtUserDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        else if(username.contains("instructor_"))
        {
            ...
            com.app.backend.model.User user = userRepository.findUserByUsername(username);
            if (user==null) {

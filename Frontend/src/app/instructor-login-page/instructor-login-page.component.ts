...
export class InstructorLoginPageComponent implements OnInit {
  ...
  constructor(private instructorLoginService : RestServiceService, private router : Router,private toastr : ToastrService) { }
  ...
  gotoSubmit(){
    this.instructorLoginService.addInstructor

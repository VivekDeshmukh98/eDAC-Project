...
export class LoginpageComponent implements OnInit,AfterViewInit {
  ...
  constructor(private restServiceService: RestServiceService, private router : Router, private activatedRoute : ActivatedRoute ,private toastr : ToastrService) { }
  ...
  gotoLogin(){
    this.restServiceService.isLoggedIn
